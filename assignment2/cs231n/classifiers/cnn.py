...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        '''
        self.params['W1'] = 0.01064*np.random.randn(num_filters, input_dim[0], filter_size, filter_size)
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = 0.01353*np.random.randn(num_filters*(input_dim[1]/2)*(input_dim[2]/2), hidden_dim)
        self.params['b2'] = np.zeros(hidden_dim)
        self.params['W3'] = 0.141421*np.random.randn(hidden_dim, num_classes)
        self.params['b3'] = np.zeros(num_classes)
        '''
        ############################################################################
        #                             END OF YOUR CODE                             #
